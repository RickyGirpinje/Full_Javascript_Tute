...
// var myFriends = new Array // array internally handle if it see square bracket
// var myFriends = ['ramesh',22,"male",'arjun',20,"male",'vishal',true, 52];
...
// var myFriends = ['ritesh','ramesh','arjun','vishal'];
...
// for(let elements in myFriends){   //this will provide us index number
//   console.log(elements);
// }

//for of loop

// for(let elements of myFriends){  //this will return elements of array
//   console.log(elements);
// }
...
// console.log(myFriendNames.lastIndexOf("vinod",2));
...
// splice(konse possition pe , kitne delete karne hai , "element jo insert karna hai ")
...
// sol2:
// console.log(newMonth);       //return deleted method like pop
...
// })
// console.log(array1);
// console.log(newArr); //it return content in new array and return boolean values
...
//         debugger;
//       return accumulator += curElem;
// },7)     // this 7 is initilise the value of accumulator
// console.log(sum);
